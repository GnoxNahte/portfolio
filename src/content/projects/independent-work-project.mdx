...
shortDescription: My final year project for polytechnic.
startDate: 2021-08-28 # format is YYYY-MM-DD
releaseDate: 2022-08-28 # format is YYYY-MM-DD
# projectLink: 
# githubLink: 
thumbnailPath: "../../images/IndependentWorkProject/IWP_Archer.png"
...
## Terrain
![IWP Terrain Generation](../../images/IndependentWorkProject/IWP_TerrainGeneration.png)
Features: 
...
## Player Classes
### Warrior
![Warrior Picture](../../images/IndependentWorkProject/IWP_Warrior.png)
Features:
...
### Archer
![Archer Picture](../../images/IndependentWorkProject/IWP_Archer.png)
Features:
