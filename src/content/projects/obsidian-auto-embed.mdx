...
thumbnailPath: "../../images/ObsidianAutoEmbed/obsidian-icon.svg"
tags: [Obsidian, Personal, Windows, Ongoing] 
# isDraft:
---

## Introduction
This post is just my progress on building the plugin. If you want to see the plugin, click the [link](https://obsidian.md/plugins?id=auto-embed). After writing this post, I realized it's very long and plan to shorten it in the future.
...
So I decided to build the plugin.

## My Progress building the plugin
### Checking if there's a existing plugin that already does this.
...
Obsidian uses a different system, [Editor Extensions](https://docs.obsidian.md/Plugins/Editor/Editor+extensions), for Live Preview. It uses [https://docs.obsidian.md/Plugins/Editor/Editor+extensions](CodeMirror) as a base. This results in the information I'm required to understand to greatly increase as I needed to learn CodeMirror too. Personally, I Obsidian's documentation on Editor Extensions is very little and the community devs using Editor Extensions is small. But I would eventually implement it through a lot of searching and asking the Discord.

### Submitting to Obsidian's plugin directory
